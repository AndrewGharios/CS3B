//@ Subroutine String_indexOf_3: Provided a two strings, this function will 
//@							  return the first occurence of second given string inside first given string.
//@ X0: Must point to a null terminated string
//@ X1: Must point to a a second null terminated string to find
...
String_indexOf_3: 
	...
	LDRB W25,[X20]			// Moves the char byte to find into W25.
...
_exit:
		...
		LDRB W22,[X19],#1	// Reload the next byte.
		LDRB W25,[X20],#1	// Reload the next byte.
...
_exit2:
	MOV X0,X21				// Moves the index of the first occurence inside the given string into x0.
